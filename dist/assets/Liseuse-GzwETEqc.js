import{c as g,u as J,j as t,s as K}from"./index-DHGFovfL.js";import{h as Z,d as O,c as s,L as ee}from"./vendor-WYr585uA.js";import"./supabase-B76hXWPk.js";const te=[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]],F=g("arrow-left",te);const re=[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"m21 3-7 7",key:"1l2asr"}],["path",{d:"m3 21 7-7",key:"tjx5ai"}],["path",{d:"M9 21H3v-6",key:"wtvkvv"}]],I=g("maximize-2",re);const ne=[["path",{d:"m14 10 7-7",key:"oa77jy"}],["path",{d:"M20 10h-6V4",key:"mjg0md"}],["path",{d:"m3 21 7-7",key:"tjx5ai"}],["path",{d:"M4 14h6v6",key:"rmj7iw"}]],$=g("minimize-2",ne);const se=[["path",{d:"M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z",key:"10ikf1"}]],ae=g("play",se);const oe=[["path",{d:"M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915",key:"1i5ecw"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],ie=g("settings",oe),R=({onVisible:p,children:l})=>{const d=s.useRef(null),[o,h]=s.useState(!1);return s.useEffect(()=>{const c=new IntersectionObserver(([x])=>{x.isIntersecting&&!o&&(p(),h(!0))},{threshold:.5});return d.current&&c.observe(d.current),()=>c.disconnect()},[o,p]),t.jsx("div",{ref:d,children:l})};function ue(){const{taleId:p,chapterId:l}=Z(),d=O(),[o,h]=s.useState(null),[c,x]=s.useState(!1),[b,w]=s.useState(!1),[z,A]=s.useState(null),[M,L]=s.useState(!0),[P,E]=s.useState(null),[T,N]=s.useState(!1),[C,U]=s.useState(!1),f=s.useRef(null),y=s.useRef(!1),{user:X}=J();s.useEffect(()=>{const e=()=>{U(!!document.fullscreenElement)};return document.addEventListener("fullscreenchange",e),()=>{document.removeEventListener("fullscreenchange",e)}},[]);const S=()=>{document.fullscreenElement&&document.exitFullscreen().catch(e=>console.error("Erreur sortie plein écran:",e)),d(-1)},v=()=>{document.fullscreenElement?document.exitFullscreen&&document.exitFullscreen():document.documentElement.requestFullscreen().catch(e=>{console.log(`Error attempting to enable fullscreen: ${e.message}`)})};s.useEffect(()=>{async function e(){try{const{data:r,error:a}=await K.from("chapters").select("*").eq("id",l).single();if(a||!r)throw console.error("DB Error:",a),new Error("Chapitre introuvable ou accès refusé.");if(r.is_premium&&!X)throw new Error("Connexion ou achat requis pour ce chapitre premium.");let n=r.content;if(!n&&r.content_url){const u=await fetch(r.content_url);if(!u.ok)throw new Error("Erreur lors du téléchargement du contenu.");n=await u.json()}if(!n)throw new Error("Contenu du chapitre vide ou manquant.");h({...n,cover_image:r.cover_image})}catch(r){console.error(r),A(r.message||"Une erreur est survenue.")}finally{L(!1)}}l&&e()},[l]);const j=(e,r)=>{if(!o?.meta?.basePaths)return r;const a=o.meta.basePaths;if(e==="voice")return a.voices+r;if(e==="music"){const n=o.audioRegistry?.tracks?.[r]||r;return a.music+n}if(e==="sfx"){const n=o.audioRegistry?.sfx?.[r]||r;return a.sfx+n}return r},D=()=>{console.log("Audio context unlocked"),document.fullscreenElement||v(),w(!0),setTimeout(()=>{x(!0),w(!1)},800)};s.useEffect(()=>{if(!c)return;const e=setTimeout(()=>{y.current||N(!0)},3e3);return()=>clearTimeout(e)},[c]);const B=(e,r,a)=>{console.log(`🗣️ VOIX [${r}]: ${a}`),y.current||(y.current=!0,N(!1)),f.current&&(f.current.pause(),f.current.currentTime=0);const n=new Audio(a);f.current=n,E(e),n.play().catch(u=>console.error("Erreur lecture audio:",u)),n.onended=()=>{E(null)}},H=e=>{const r=j("sfx",e);console.log(`💥 SFX: ${r}`)},q=(e,r)=>{const a=j("music",r);console.log(`🎵 MUSIC [${e}]: ${a}`)},Y=e=>{console.log(`💾 Checkpoint: ${e}`)};if(M)return t.jsx("div",{className:"liseuse-loading",children:"Chargement du récit..."});if(z)return t.jsxs("div",{className:"liseuse-error",children:[t.jsx("p",{children:z}),t.jsx(ee,{to:`/tale/${p}`,className:"back-link",children:"Retour au Tale"})]});if(!o)return null;let i=o.cover_image||o.meta?.coverImage;if(i&&!i.startsWith("http")&&!i.startsWith("blob")){const e="https://gmunwpptyhwiiffcbhcq.supabase.co",r=i.split("/").map(a=>encodeURIComponent(a)).join("/");i=`${e}/storage/v1/object/public/${r}`}i||(i="https://placehold.co/400x600/1f2023/FFF?text=No+Image");const V=o.blocks.findIndex(e=>e.type==="dialogue"),G=!c||b,Q=c||b;return t.jsxs(t.Fragment,{children:[G&&t.jsxs("div",{className:`start-screen ${b?"exiting":""}`,children:[t.jsxs("div",{className:"start-screen-header",children:[t.jsx("button",{onClick:S,className:"icon-btn",children:t.jsx(F,{size:24})}),t.jsx("button",{onClick:v,className:"icon-btn",children:C?t.jsx($,{size:24}):t.jsx(I,{size:24})})]}),t.jsx("h1",{className:"chapter-title stagger-item delay-1",children:o.meta.title}),t.jsx("div",{className:"cover-container stagger-item delay-2",children:t.jsx("img",{src:i,alt:"Cover",className:"cover-image",onError:e=>{e.target.onerror=null,e.target.src="https://placehold.co/400x600/1f2023/FFF?text=No+Image"}})}),t.jsxs("button",{className:"start-btn stagger-item delay-3",onClick:D,children:[t.jsx(ae,{size:20,fill:"currentColor",style:{marginRight:"10px"}}),"COMMENCER LA LECTURE"]}),t.jsx("style",{children:`
          ...
          `})]}),Q&&t.jsxs("div",{className:"liseuse-container page page--zoom",children:[t.jsxs("header",{className:"liseuse-header",children:[t.jsxs("button",{onClick:S,className:"liseuse-nav-btn",children:[t.jsx(F,{size:20})," Quitter"]}),t.jsxs("div",{className:"liseuse-controls",children:[t.jsx("button",{onClick:v,className:"liseuse-icon-btn",children:C?t.jsx($,{size:20}):t.jsx(I,{size:20})}),t.jsx("button",{className:"liseuse-icon-btn",children:t.jsx(ie,{size:20})})]})]}),t.jsx("div",{className:"liseuse-content",children:o.blocks.map((e,r)=>{switch(e.type){case"text":return t.jsx("p",{className:"block-text",children:e.content},r);case"dialogue":const a=j("voice",e.voiceFile||e.audioSrc),n=P===r,W=r===V&&T,_="#feca57";return t.jsx("div",{className:`block-dialogue ${n?"dialogue--active":""} ${W?"dialogue--hint":""}`,style:{borderLeftColor:n?_:"#1f2023",backgroundColor:n?"rgba(0,0,0,0.05)":void 0,boxShadow:n?`inset 4px 0 0 0 ${_}, 0 4px 20px rgba(0,0,0,0.1)`:void 0,transform:n?"translateX(4px)":void 0},onClick:()=>B(r,"Dialogue",a),children:t.jsx("div",{className:"dialogue-content",children:e.turns?e.turns.map((k,m)=>t.jsx("p",{style:{marginBottom:m===e.turns.length-1?0:"0.8rem",margin:0},children:k.content},m)):Array.isArray(e.content)?e.content.map((k,m)=>t.jsx("p",{style:{marginBottom:m===e.content.length-1?0:"0.8rem",margin:0},children:k},m)):t.jsx("p",{style:{margin:0},children:e.content})})},r);case"sfx_cue":return t.jsx(R,{onVisible:()=>H(e.sfxId),children:t.jsx("div",{className:"debug-trigger",children:"⚡"})},r);case"music_cue":return t.jsx(R,{onVisible:()=>q(e.action,e.trackId),children:t.jsx("div",{className:"debug-trigger",children:"🎵"})},r);case"checkpoint":return Y(e.id),null;default:return null}})}),t.jsx("style",{children:`
